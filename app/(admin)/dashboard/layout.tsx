                    ...
                    <main className="flex justify-center items-center h-screen p-6">
                        <div className="text-center">
                            <p className="text-[24px]">
                                ขออภัย กรุณา Login ก่อนใช้งานหน้านี้ด้วยค่ะ
                            </p>
                            <a
                                href="/login"
                                className="bg-[#3a82f6] hover:bg-[#2c68c9] rounded-md px-4 py-2 mt-8"
                            >
                                Login
                            </a>
                        </div>
                    ...
                    <div className="min-h-screen flex text-white">
                        ...
                        <Transition.Root show={sidebarOpen} as={Fragment}>
                            ...
                            >
                                ...
                                >
                                    <Dialog.Panel className="relative bg-gray flex-1 flex flex-col max-w-xs w-full">
                        ...
                        <div className="hidden md:flex md:flex-shrink-0">
                            <div className="flex flex-col w-64 bg-gradient-to-b from-[#060606] border-r border-[#282524]">
                                <div
                                    className={clsx(
                                        `bg-[#060606]`,
                                        "h-16 flex items-center justify-center text-xl font-bold border-b border-[#282524] text-white"
                                    )}
                                >
                                    Menu
                                </div>
