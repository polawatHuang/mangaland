...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col md:flex-row">
      ...
      <aside
        className={clsx(
          "fixed md:relative inset-y-0 left-0 w-64 bg-[#374151] p-4 flex flex-col transition-transform duration-300",
      ...
      <main className="flex-1 p-6 md:ml-64">
        ...
        {/* Dashboard Content */}
        <section className="mt-6 grid grid-cols-1 gap-6">{children}</section>
      </main>
    </div>
  );
}
