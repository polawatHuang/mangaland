...
const NewManga = dynamic(
    () => import("@/app/components/Home/NewManga/NewManga")
);
const TopManga = dynamic(
    () => import("@/app/components/Home/TopManga/TopManga")
);
const ForYouManga = dynamic(
    () => import("@/app/components/Home/ForYouManga/ForYouManga")
);
const TagManga = dynamic(
    () => import("@/app/components/Home/TagManga/TagManga")
);
